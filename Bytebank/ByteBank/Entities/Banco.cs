...
namespace ClasseBanco
{
    internal class Banco
    {
        ...
        public static void ManipularConta(List<string> nome, List<int> idade, List<double> saldo, List<string> cpf, List<string> senha)
        {
            ...
            static void RealizarSaque(double qtdSacar, List<string> nome, List<double> saldo)
            {
            ...
            static void RealizarDeposito(double qtdDeposito, List<string> nome, List<double> saldo)
            {
            ...
            static void RealizarTransferencia(double qtdTransferencia, List<string> nome, List<double> saldo)
            {
